...
save([ReplicationFolder '/results/Age_Prediction/2Fold_Sort_Fold0_Specificity_Sig.mat'], 'ParCorr_Actual_Fold0', 'ParCorr_Rand_Fold0', 'ParCorr_Fold0_Sig', 'MAE_Actual_Fold0', 'MAE_Rand_Fold0', 'MAE_Fold0_Sig');
% Fold 1
