...
Fig <- Fig + 
       ...
       theme(axis.text=element_text(size=29, color='black'), axis.title=element_text(size=29)) + 
...
ggsave(paste0(FigureFolder, '/AgePrediction_CorrACC.tiff'), width = 17, height = 15, dpi = 300, units = "cm");
