...
for i = 94:100
  ...
  ResultantFolder = [EnergyFolder '/NullNetworks/InitialAll0_TargetLimbic_NullNetwork_' num2str(i)];
...
for i = 1:100
  ...
  EnergyMat_Path = [EnergyFolder '/NullNetworks/InitialAll0_TargetLimbic_NullNetwork_' num2str(i) '.mat'];
