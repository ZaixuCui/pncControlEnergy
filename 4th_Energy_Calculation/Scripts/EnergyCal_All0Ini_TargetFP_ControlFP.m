...
% Only control FP system, then control set is the same with constrain set
xc = S;

ResultantFolder = [EnergyFolder '/InitialAll0_TargetFP_ControlFP'];
...
EnergyMat_Path = [EnergyFolder '/InitialAll0_TargetFP_ControlFP.mat'];
