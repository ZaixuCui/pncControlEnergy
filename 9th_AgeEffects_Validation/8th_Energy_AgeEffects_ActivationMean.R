...
ResultantFolder <- paste0(ReplicationFolder, '/results/InitialAll0_TargetActivationMean');
...
Energy_Gam_Age_YeoAvg <- matrix(0, nrow = SystemsQuantity, ncol = 4, dimnames = list(RowName_Yeo, c("Z", "P", "P_FDR", "Partial_Corr")));
...
Energy_Gam_Age_CSV <- file.path(ResultantFolder, 'Energy_Gam_Age_YeoSystemLevel_TargetActivationMean.csv');
write.csv(Energy_Gam_Age_YeoAvg, Energy_Gam_Age_CSV);
Energy_Gam_Age_Mat <- file.path(ResultantFolder, 'Energy_Gam_Age_YeoSystemLevel_TargetActivationMean.mat');
...
Energy_Gam_Age_CSV <- file.path(ResultantFolder, 'Energy_Gam_Age_NodalLevel_TargetActivationMean.csv');
write.csv(Energy_Gam_Age_New, Energy_Gam_Age_CSV);
Energy_Gam_Age_Mat <- file.path(ResultantFolder, 'Energy_Gam_Age_NodalLevel_TargetActivationMean.mat');
