...
[ParCorr_Actual_Fold0, ~] = partialcorr(Prediction_Fold0_PC.Predict_Score', Age_Fold0, double([Sex_Fold0 Handedness_Fold0 Motion_Fold0 TBV_Fold0 TotalStength_Fold0]));
[ParCorr_Actual_Fold1, ~] = partialcorr(Prediction_Fold1_PC.Predict_Score', Age_Fold1, double([Sex_Fold1 Handedness_Fold1 Motion_Fold1 TBV_Fold1 TotalStength_Fold1]));
...
[ParCorr_Actual_Fold0, ~] = partialcorr(Prediction_Fold0_Energy.Predict_Score', Age_Fold0, double([Sex_Fold0 Handedness_Fold0 Motion_Fold0 TBV_Fold0 TotalStength_Fold0 Prediction_Fold0_PC.Predict_Score']));
[ParCorr_Actual_Fold1, ~] = partialcorr(Prediction_Fold1_Energy.Predict_Score', Age_Fold1, double([Sex_Fold1 Handedness_Fold1 Motion_Fold1 TBV_Fold1 TotalStength_Fold1 Prediction_Fold1_PC.Predict_Score']));
...
for i = 1:1000
  ...
  ParCorr_Rand_Fold0(i) = partialcorr(tmp_Energy.Predict_Score', Age_Fold0, double([Sex_Fold0 Handedness_Fold0 Motion_Fold0 TBV_Fold0 TotalStength_Fold0 tmp_PC.Predict_Score']));
end
ParCorr_Fold0_Sig = length(find(ParCorr_Rand_Fold0 >= ParCorr_Actual_Fold0)) / 1000;
...
for i = 1:1000
  ...
  ParCorr_Rand_Fold1(i) = partialcorr(tmp_Energy.Predict_Score', Age_Fold1, double([Sex_Fold1 Handedness_Fold1 Motion_Fold1 TBV_Fold1 TotalStength_Fold1 tmp_PC.Predict_Score']));
end
ParCorr_Fold1_Sig = length(find(ParCorr_Rand_Fold1 >= ParCorr_Actual_Fold1)) / 1000;
