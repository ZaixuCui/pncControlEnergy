...
ResultantFolder = ReplicationFolder + '/results/Age_Prediction/2Fold_Sort_NS';
Ridge_CZ_Sort.Ridge_KFold_Sort(NS, Age, FoldQuantity, Alpha_Range, ResultantFolder, 1, 0);
...
ResultantFolder = ReplicationFolder + '/results/Age_Prediction/2Fold_Sort_Permutation_NS';
Ridge_CZ_Sort.Ridge_KFold_Sort_Permutation(NS, Age, Times_IDRange, FoldQuantity, Alpha_Range, ResultantFolder, 1, 1000, '-q all.q,basic.q', Permutation_RandIndex_File_List)
